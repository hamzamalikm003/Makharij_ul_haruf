...
//                    Log.d("STATE",rb.getText().toString());
    ...
    private void initialize(){
        scrollView = findViewById(R.id.Scroll_ID);
        tbLayout = findViewById(R.id.QuizTable);
        ...
        questions = new Question[]{
                ...
                new Question("The letters ح is belong from which makharij","Halqiyah",new Options[]
                        {
                                new Options("Lahatiyah"),
                                new Options("Tarfiyah"),
                                new Options("Halqiyah")
                        }),
                new Question("The letters ر is belong from which makharij","Tarfiyah",new Options[]
                        {
                                new Options("Lahatiyah"),
                                new Options("Tarfiyah"),
                                new Options("Halqiyah")
